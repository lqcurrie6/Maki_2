...
while True:
	...
	serial_connection.goto(dynamixel_id, 0, speed=50, degrees=True)
	serial_connection.goto(dynamixel_id_4, -70, speed=40, degrees=True)
	time.sleep(0) # Wait 1 second
	
'''
# Go to -70° (moves eyes midway)
serial_connection.goto(dynamixel_id_4, -70, speed=80, degrees=True)
time.sleep(.35) # Wait 1 second
# Go to -90° (moves eyed down)
serial_connection.goto(dynamixel_id_4, -90, speed=80, degrees=True)
time.sleep(.35) # Wait 1 second
# Go to -135° (moves eyes to it's maximum)
serial_connection.goto(dynamixel_id_4, -115, speed=80, degrees=True)
time.sleep(.35) # Wait 1 second
# Go to -70° (moves eyes midway)
serial_connection.goto(dynamixel_id_4, -70, speed=80, degrees=True)
time.sleep(.35) # Wait 1 second
...
serial_connection.goto(dynamixel_id_5, 0, speed=70, degrees=True)
time.sleep(.35) # Wait 1 second
# Go to -25° (move head forward)
serial_connection.goto(dynamixel_id_5, -25, speed=70, degrees=True)
time.sleep(.35) # Wait 1 second
# Go to 10° (nods head back)
serial_connection.goto(dynamixel_id_5, 10, speed=70, degrees=True)
time.sleep(.35) # Wait 1 second
...
time.sleep(.40) # Wait 1 second'
#opens eyelid midway'''
'''serial_connection.goto(dynamixel_id_6, -45, speed=140, degrees=True)
time.sleep(.40) # Wait 1 second'''
...
serial_connection.goto(dynamixel_id_7, 75, speed=140, degrees=True)
time.sleep(.40) # Wait 1 second
# Goes to +50 degrees(closes eyelid midway)
serial_connection.goto(dynamixel_id_7, 50, speed=140, degrees=True)
time.sleep(.40) # Wait 1 second
# Go to +15° (opens eyelid)
serial_connection.goto(dynamixel_id_7, 30, speed=140, degrees=True)
time.sleep(.40) # Wait 1 second'''
